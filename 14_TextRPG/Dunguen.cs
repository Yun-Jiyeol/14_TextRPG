    ...
    internal class Dunguen
    {
        ...
        public void EasyDuguen(Player P, Inven inven, QuestManager quest)
        {
            ...
            while (isdunguen)
            {
                ...
                DesignText.MiddleDT("", 40, ConsoleColor.Gray);
                DesignText.LeftDT("  0. 마을로 귀환", 18, ConsoleColor.Blue);
                DesignText.MiddleDT("", 40, ConsoleColor.Gray);
                Console.ForegroundColor = ConsoleColor.Cyan;
                Console.Write("┗━");
                Console.ForegroundColor = ConsoleColor.DarkCyan;
        ...
        public void NormalDuguen(Player P, Inven inven, QuestManager quest)
        {
            int floor = 1;
            int maxfloor = 4;
            bool isdunguen = true;
        ...
        public void HardDuguen(Player P, Inven inven, QuestManager quest)
        {
            int floor = 1;
            int maxfloor = 5;
            bool isdunguen = true;
            ...
            while (isdunguen)
            {
                ...
                switch (input)
                {
                    ...
                    case 1:
                        ...
                        {
                            monsters = battle.SpawnMons(12, 17); //랜덤 몬스터 소환
                        }
