            ...
            for (int i = 0; i < monsNum; i++)//몬스터 수 만큼 실행
            {
                ...
                switch (index)
                {
                    case 0: //순서대로 이름,직업,레밸,주는경험치,체력,최대체력,공격력,방어력
                        mons.Add(new Monster("E슬라임","슬라임",1,5, 100, 100, 10 , 1));
                        break;
                    case 1:
                        mons.Add(new Monster("E주황버섯","버섯", 1 , 5, 100, 100, 10, 1));
                        break;
                    case 2:
                        mons.Add(new Monster("E초록버섯","버섯",1, 5, 100, 100, 10,1));
                        break;
                    case 3:
                        mons.Add(new Monster("E스톤 골렘","골렘",1, 5, 100, 100, 10,1));
                        break;
                    case 4:
                        mons.Add(new Monster("E타우로마시스","타우로마시스",1, 5, 100, 100, 10,1));
                        break;
                    case 5:
                        mons.Add(new Monster("E주니어 발록","발록",1, 5, 100, 100, 10,1));
                        break;
                    case 6:
