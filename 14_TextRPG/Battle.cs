        ...
        public List<Monster> SpawnMons(int min, int max)
        {
            ...
            {   //이지
                ...
                case 2:
                    ...
                    mons.Add(new Monster("(E)      좀비", "언데드", 2, 3, 11, 11, 7, 2));
                    mons.Add(new Monster("(E) 그린 버섯", "버섯", 2, 5, 20, 20, 10, 1));
                    break;
                case 3:
                    mons.Add(new Monster("(E) 스톤 골렘", "골렘", 2, 8, 30, 30, 12, 8));
                    break;
                case 4:
                    mons.Add(new Monster("(E) 스켈레톤", "언데드", 2, 5, 16, 16, 8, 4));
                    mons.Add(new Monster("(E) 스켈레톤", "언데드", 2, 5, 16, 16, 8, 4));
                    mons.Add(new Monster("(E)     좀비", "언데드", 2, 3, 11, 11, 8, 4));
                    break;
                case 5:
                    mons.Add(new Monster("(E) 새끼 거미", "거미", 3, 5, 10, 10, 8, 5));
                    mons.Add(new Monster("(E) 새끼 거미", "거미", 3, 5, 10, 10, 8, 5));
                    mons.Add(new Monster("(E) 새끼 거미", "거미", 3, 5, 10, 10, 8, 5));
                    mons.Add(new Monster("(E) 새끼 거미", "거미", 3, 5, 10, 10, 8, 5));
                    break;
